...
class CustomSimulator:
    ...
    def _calculate_acceleration(state, forces, mass, mass_moment):
        ...
        for force in forces:
            ...
            theta_acceleration += math.degrees(force_torque / mass_moment)
    ...
    def _calculate_change(self, rigid_body, state):
        ...
        [acceleration, theta_acceleration] = \
            CustomSimulator._calculate_acceleration(
                state, forces,
                rigid_body.mass(), rigid_body.moment())

        return CustomSimulator.StateChange(state.vel, acceleration,
    ...
    class StateChange:
        ...
        def multiply(self, time):
            return CustomSimulator.StateChange(
